...
class PegawaiExport implements FromQuery, WithColumnFormatting, WithMapping, WithHeadings,ShouldAutoSize,WithStyles
{
    ...
    public function map($model): array
    {
        ...
        return [
            ...
            'Rp ' . number_format($model->tunjangan_bpjs_kesehatan, 0, ',', '.'),
            'Rp ' . number_format($model->tunjangan_bpjs_ketenagakerjaan, 0, ',', '.'),
            'Rp ' . number_format($model->tunjangan_pajak, 0, ',', '.'),
            '>>>',
            ...
            'Rp ' . number_format($model->potongan_bpjs_kesehatan, 0, ',', '.'),
            'Rp ' . number_format($model->potongan_bpjs_ketenagakerjaan, 0, ',', '.'),
        ];
