...
class PayrollController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated['tunjangan_pajak'] = str_replace(',', '', $validated['tunjangan_pajak']);            $validated['potongan_bpjs_ketenagakerjaan'] = str_replace(',', '', $validated['potongan_bpjs_ketenagakerjaan']);
        ...
        try {
            ...
            $user_update = User::find($validated['user_id']);
            $user_update->update([
    ...
    public function hitungPajak(User $user)
    {
        ...
        $pajak = Pajak::where('user_id', $user->id)
            ->where('bulan', $payroll->bulan)
            ->where('tahun', $payroll->tahun)
            ->first();
        $dataPajak = [
        ...
        if ($pajak) {
            $pajak->update($dataPajak);
        } else {
            Pajak::create(array_merge($dataPajak, [
                'user_id' => $user->id,
                'bulan' => $payroll->bulan,
                'tahun' => $payroll->tahun,
            ]));
    ...
    public function delete($id)
    {
        ...
        $pajak = Pajak::where('payroll_id', $id);
        $pajak->delete();
