...
use App\Http\Controllers\TarifPphController;
...
Route::get('/tarif-pph', [TarifPphController::class, 'index'])->middleware('admin');
Route::get('/tarif-pph/create', [TarifPphController::class, 'create'])->name('tarif-pph.create')->middleware('admin');
Route::post('/tarif-pph', [TarifPphController::class, 'store'])->name('tarif-pph.store')->middleware('admin');
Route::get('/tarif-pph/{tarif_pph}/edit', [TarifPphController::class, 'edit'])->name('tarif-pph.edit')->middleware('admin');
Route::put('/tarif-pph/{tarif_pph}', [TarifPphController::class, 'update'])->name('tarif-pph.update')->middleware('admin');
Route::delete('/tarif-pph/{tarif_pph}', [TarifPphController::class, 'destroy'])->name('tarif-pph.destroy')->middleware('admin');

Route::get('/pajak-pph21', [PajakController::class, 'index'])->middleware('admin');
Route::get('/data-pajak/export', [PajakController::class, 'exportDataPajak'])->middleware('admin');
Route::get('/data-pajak/{id}/{payroll_id}/download', [PajakController::class, 'downloadDataPajak'])->middleware('admin');
Route::get('/data-pajak-user/{id}/download', [PajakController::class, 'downloadDataPajakUser'])->middleware('auth');
