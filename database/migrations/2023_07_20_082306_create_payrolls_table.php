...
class CreatePayrollsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('payrolls', function (Blueprint $table) {
            ...
            $table->bigInteger('tunjangan_bpjs_kesehatan')->nullable()->default(0);
            $table->bigInteger('tunjangan_bpjs_ketenagakerjaan')->nullable()->default(0);
            $table->bigInteger('potongan_bpjs_kesehatan')->nullable()->default(0);
            $table->bigInteger('potongan_bpjs_ketenagakerjaan')->nullable()->default(0);
            $table->bigInteger('potongan_pajak_pph21')->nullable()->default(0);
            $table->bigInteger('tunjangan_pajak')->nullable()->default(0);
