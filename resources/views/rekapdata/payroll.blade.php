            ...
            <div class="card">
                <form method="post" action="{{ url('/rekap-data/payroll/tambah') }}" enctype="multipart/form-data" class="p-4">
                    ...
                    <div class="row">
                         <div class="col mb-4">
                            <div class="card p-4">
                                <label for="tunjangan">Tunjangan BPJS dan Pajak</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('tunjangan_bpjs_kesehatan') is-invalid @enderror" id="tunjangan_bpjs_kesehatan" style="background-color: orange" name="tunjangan_bpjs_kesehatan" value="{{ old('tunjangan_bpjs_kesehatan', $user->tunjangan_bpjs_kesehatan) }}">
                                    <div class="input-group-text">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('tunjangan_bpjs_ketenagakerjaan') is-invalid @enderror" id="tunjangan_bpjs_ketenagakerjaan" style="background-color: orange" name="tunjangan_bpjs_ketenagakerjaan" value="{{ old('tunjangan_bpjs_ketenagakerjaan', $user->tunjangan_bpjs_ketenagakerjaan) }}">
                                    <div class="input-group-text">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('tunjangan_pajak') is-invalid @enderror" id="tunjangan_pajak" style="background-color: orange" name="tunjangan_pajak" value="{{ old('tunjangan_pajak', $user->tunjangan_pajak) }}">
                                    <div class="input-group-text">
                                        <span>Tunjangan Pajak</span>
                                    </div>
                             ...
                             <div class="col mb-4">
                            <div class="card p-4">
                                <label for="tunjangan">Potongan BPJS</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('potongan_bpjs_kesehatan') is-invalid @enderror" id="potongan_bpjs_kesehatan" style="background-color: orange" name="potongan_bpjs_kesehatan" value="{{ old('potongan_bpjs_kesehatan', $user->potongan_bpjs_kesehatan) }}">
                                    <div class="input-group-text">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('potongan_bpjs_ketenagakerjaan') is-invalid @enderror" id="potongan_bpjs_ketenagakerjaan" style="background-color: orange" name="potongan_bpjs_ketenagakerjaan" value="{{ old('potongan_bpjs_ketenagakerjaan', $user->potongan_bpjs_ketenagakerjaan) }}">
                                    <div class="input-group-text">
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#proses").click(function(e) {
                    ...
                    var jumlah_bpjs_kes = $('#tunjangan_bpjs_kesehatan').val() ? parseFloat(replaceCurrency($('#tunjangan_bpjs_kesehatan').val())) : 0;
                    var jumlah_bpjs_ket = $('#tunjangan_bpjs_ketenagakerjaan').val() ? parseFloat(replaceCurrency($('#tunjangan_bpjs_ketenagakerjaan').val())) : 0;
                    var jumlah_pajak = $('#tunjangan_pajak').val() ? parseFloat(replaceCurrency($('#tunjangan_pajak').val())) : 0;

                    var total_penjumlahan = gaji_pokok + total_reimbursement + uang_transport + total_lembur + bonus_pribadi + bonus_team + bonus_jackpot + total_kehadiran + total_thr + jumlah_bpjs_kes + jumlah_bpjs_ket + jumlah_pajak;
                    ...
                    var potongan_bpjs_kesehatan = $('#potongan_bpjs_kesehatan').val() ? parseFloat(replaceCurrency($('#potongan_bpjs_kesehatan').val())) : 0;
                    var potongan_bpjs_ketenagakerjaan = $('#potongan_bpjs_ketenagakerjaan').val() ? parseFloat(replaceCurrency($('#potongan_bpjs_ketenagakerjaan').val())) : 0;
                    ...
                    var total_pengurangan = total_mangkir + total_izin + total_terlambat + bayar_kasbon + loss + potongan_bpjs_kesehatan + potongan_bpjs_ketenagakerjaan;
