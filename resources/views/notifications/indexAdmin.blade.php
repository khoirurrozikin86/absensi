                            ...
                            <div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item"
                                                                href="{{ url('/notifications/read') }}">Read</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url('/notifications/unread') }}">Unread</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="inbox">
                                    @foreach ($inboxs as $inbox)
                                        ...
                                        @endphp
                                        <a href="{!! !$inbox->read_at ? url('/notifications/read-message/' . $inbox->id) : url($inbox->data['action']) !!}" class="d-flex"
                                                ...
                                                <label class="d-block mb-0">
                                                    @if ($user?->foto_karyawan == null)
                                                        <img class="me-3 rounded-circle"
                                                            src="{{ url('assets/img/foto_default.jpg') }}" alt="image">
                                                    @else
                                                        <img class="me-3 rounded-circle"
                                                            src="{{ url('/storage/' . $user->foto_karyawan) }}"
                                                            alt="">
                                                    @endif
                                            </div>
                                            <div class="flex-grow-1">
