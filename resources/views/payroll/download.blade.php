  ...
  <div class="container">
    ...
    <table style="font-size: 13px">
      <tbody>
        ...
        <tr>
          ...
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->tunjangan_bpjs_kesehatan) }}</td>
        </tr>
        <tr>
          ...
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->tunjangan_bpjs_ketenagakerjaan) }}</td>
        </tr>
        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Tunjangan Pajak</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->tunjangan_pajak) }}</td>
        </tr>
        <tr>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
    ...
    <table style="font-size: 13px">
      <tbody>
        ...
        <tr>
          <td style="padding-left: 10px; padding-right: 17px">Potongan BPJS Kesehatan</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->potongan_bpjs_kesehatan) }}</td>
        </tr>
        <tr>
          <td style="padding-left: 10px; padding-right: 17px">Potongan BPJS KetenagaKerjaan</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->potongan_bpjs_ketenagakerjaan) }}</td>
        </tr>
        <tr>
