                ...
                <tbody>
                    @foreach ($data as $key => $d)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/data-pajak-user/'.$d->id.'/download') }}" target="_blank"><i class="fa fa-solid fa-download me-1"></i> Download Pajak</a>
                            </td>
                            <td>
                                <a href="{{ url('/payroll/'.$d->id.'/download') }}" target="_blank"><i class="fa fa-solid fa-download me-1"></i> Download Slip Gaji</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
