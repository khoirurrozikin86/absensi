                ...
                <form class="p-4" method="post" action="{{ url('/pegawai/tambah-pegawai-proses') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <input type="text" class="form-control money @error('tunjangan_pajak') is-invalid @enderror" name="tunjangan_pajak" value="{{ old('tunjangan_pajak') }}">
