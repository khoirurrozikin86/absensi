                            ...
                            <form method="post" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <select name="status_pajak" id="status_pajak" class="form-control @error('status_pajak') is-invalid @enderror selectpicker" data-live-search="true">
                                            <option value="">Pilih Status Pajak</option>
                                            @foreach ($sPajak as $s)
                                                @if(old('status_pajak', auth()->user()->status_pajak) == $s["status"])
                                                    <option value="{{ $s["status"] }}" selected>{{ $s["status"] }}</option>
                                                @else
                                                    <option value="{{ $s["status"] }}">{{ $s["status"] }}</option>
                                                @endif
                                ...
                                <div class="col mb-4">
                                    <h3 style="color: blue">Tunjangan & Potongan Pajak / BPJS</h3>
                                </div>
                                <div class="row">
                                    <div class="col mb-4">
                                        <label for="tunjangan_bpjs_kesehatan">Tunjangan BPJS Kesehatan</label>
                                        <input type="text" class="form-control money @error('tunjangan_bpjs_kesehatan') is-invalid @enderror" name="tunjangan_bpjs_kesehatan" value="{{ old('tunjangan_bpjs_kesehatan', auth()->user()->tunjangan_bpjs_kesehatan) }}" disabled>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="text" class="form-control money @error('tunjangan_bpjs_ketenagakerjaan') is-invalid @enderror" name="tunjangan_bpjs_ketenagakerjaan" value="{{ old('tunjangan_bpjs_ketenagakerjaan', auth()->user()->tunjangan_bpjs_ketenagakerjaan) }}"disabled>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="text" class="form-control money @error('potongan_bpjs_kesehatan') is-invalid @enderror" name="potongan_bpjs_kesehatan" value="{{ old('potongan_bpjs_kesehatan', auth()->user()->potongan_bpjs_kesehatan) }}" disabled>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="text" class="form-control money @error('potongan_bpjs_ketenagakerjaan') is-invalid @enderror" name="potongan_bpjs_ketenagakerjaan" value="{{ old('potongan_bpjs_ketenagakerjaan', auth()->user()->potongan_bpjs_ketenagakerjaan) }}" disabled>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        <label for="tunjangan_pajak">Tunjangan Pajak (Gross Up)</label>
                                        <input type="text" class="form-control money @error('tunjangan_pajak') is-invalid @enderror" name="tunjangan_pajak" value="{{ old('tunjangan_pajak', auth()->user()->tunjangan_pajak) }}" disabled>
