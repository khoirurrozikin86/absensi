                                    ...
                                    <form class="tf-form" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="tf-container">
                                            ...
                                            <div class="group-input">
                                                ...
                                                @endphp
                                                <label for="status_pajak" style="z-index: 10">Status Pajak</label>
                                                <select name="status_pajak" id="status_pajak" class="@error('status_pajak') is-invalid @enderror" data-live-search="true">
                                                    <option value="">Pilih Status Pernikahan</option>
                                                    @foreach ($sPajak as $s)
                                ...
                                <ul class="mt-3 mb-5">
                                    ...
                                    <form class="tf-form" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="tf-container">
                                            ...
                                            <h3>Tunjangan BPJS & PAJAK</h3>
                                            <br>
                                            <div class="group-input">
                                                <label>Tunjangan BPJS Kesehatan</label>
                                                <input type="text" class="money @error('tunjangan_bpjs_kesehatan') is-invalid @enderror" 
                                                    name="tunjangan_bpjs_kesehatan" 
                                                    value="{{ old('tunjangan_bpjs_kesehatan', auth()->user()->tunjangan_bpjs_kesehatan) }}" 
                                                    readonly />
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="money @error('tunjangan_bpjs_ketenagakerjaan') is-invalid @enderror" 
                                                    name="tunjangan_bpjs_ketenagakerjaan" 
                                                    value="{{ old('tunjangan_bpjs_ketenagakerjaan', auth()->user()->tunjangan_bpjs_ketenagakerjaan) }}" 
                                                    readonly />
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="money @error('tunjangan_pajak') is-invalid @enderror" 
                                                    name="tunjangan_pajak" 
                                                    value="{{ old('tunjangan_pajak', auth()->user()->tunjangan_pajak) }}" 
                                                    readonly />
                            ...
                            <div class="tf-container">
                                <ul class="mt-3 mb-5">
                                    ...
                                    <form class="tf-form" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data" method="POST">
                                        ...
                                        @csrf
                                        <div class="tf-container">
                                            <h3>Pengurangan BPJS</h3>
                                            <br>
                                            <div class="group-input">
                                                <label>Potongan BPJS Kesehatan</label>
                                                <input type="text" class="money @error('potongan_bpjs_kesehatan') is-invalid @enderror" name="potongan_bpjs_kesehatan" value="{{ old('potongan_bpjs_kesehatan', auth()->user()->potongan_bpjs_kesehatan) }}" readonly />
                                            ...
                                            <div class="group-input">
                                                ...
                                                <input type="text" class="money @error('potongan_bpjs_ketenagakerjaan') is-invalid @enderror" name="potongan_bpjs_ketenagakerjaan" value="{{ old('potongan_bpjs_ketenagakerjaan', auth()->user()->potongan_bpjs_ketenagakerjaan) }}" readonly />
