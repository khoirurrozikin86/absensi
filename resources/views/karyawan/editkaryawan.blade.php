                            ...
                            <form method="post" action="{{ url('/pegawai/proses-edit/'.$karyawan->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <select name="status_pajak" id="status_pajak" class="form-control @error('status_pajak') is-invalid @enderror selectpicker" data-live-search="true">
                                            ...
                                            @foreach ($statusPajak as $sp)
                                                <option value="{{ $sp }}" {{ old('status_pajak', $karyawan->status_pajak) == $sp ? 'selected' : '' }}>
                                                    {{ $sp }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="text" class="form-control money @error('tunjangan_pajak') is-invalid @enderror" name="tunjangan_pajak" value="{{ old('tunjangan_pajak', $karyawan->tunjangan_pajak) }}">
